  ...
  <div class="max-w-300 mx-auto">
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div flex="~ gap-2 justify-center">
        ...
        <a
          href="https://releases.lpieces.cn"
          target="_blank"
      ...
      >
        ...
        >
          <div v-if="item.icon" class="pt-2 pr-5">
            ...
            <LPieces v-else-if="item.icon === 'lp'" class="text-4xl opacity-50" />
    ...
    <div class="prose pb5 mx-auto mt10 text-center">
      <div block mt-5>
        <a href="https://lpices.cn/stars-rank" target="_blank" op50>All projects sort by Stars</a>
      </div>
    </div>
  </div>
  <div>
