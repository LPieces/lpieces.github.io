      ...
      async markdownItSetup(md) {
        ...
        md.use(MarkdownItMagicLink, {
          linksMap: {
            ...
            'React': 'https://github.com/react/core',
            'TypeScript': { link: 'https://github.com/Microsoft/TypeScript', imageUrl: 'https://typescript.bootcss.com/images/typescript-icon.svg' },
          },
          imageOverrides: [
